...
int main(int argc, const char *argv[])
{
    ...
    for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex+=imgStepWidth)
    {
        ...
        // run YOLOv3 pretrained on COCO
        // the resulting bounding boxes are stored in dataBuffer
        ...
        // caveat: these are arbitrary values which only work for this particular driving scenario
        ...
        // adds the associated lidarPoints into dataBuffer
